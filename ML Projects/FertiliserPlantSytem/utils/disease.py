disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/>Disease: Apple Scab<br/>
        ...
        <br/><br/> Fertiliser Recomended /cure the disease <br/>
        <br/>1. Name: Bonide Copper Fungicide Dust or Spray , Espoma Tree-Tone Fruit & Shade Tree Food ,Jobe's Organics Fruit & Citrus Fertilizer Spikes.
        <br/>2. Active Ingredient: Copper Octanoate (Copper Soap).
        <br/>3. Deficiency : What It Addresses: Restores overall nutrient balance, focusing on Nitrogen (N) for leaf health, Phosphorus (P) for root and flower development, and Potassium (K) for disease resistance.
        <br/>4. Price: Approximately $15-20 for a 1 lb container (price may vary based on location and supplier).
        <br/>5. How to Use: Shake the container well before use Mix 2 to 3 tablespoons of the fungicide per gallon of water for spray applications.
        """,
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/>Disease: Black Rot<br/>
        ...
        <br/><br/> Fertiliser Recomended/cure the disease <br/>
        <br/>1. Name: Southern Ag Liquid Copper Fungicide , Down To Earth All Natural Tree & Shrub Fertilizer , Dr. Earth Natural Wonder Fruit Tree Fertilizer.
        <br/>2. Active Ingredient: Southern Ag Liquid Copper Fungicide.
        <br/>3. Deficiency : What It Addresses: Enhances nutrient levels, particularly Nitrogen for foliage, Phosphorus for root strength, and Potassium for disease resistance.
        <br/>4. Price:  Approximately $15-25 for a 1 pint bottle (price may vary based on location and supplier).
        <br/>5. Shake the bottle well before use Mix 2 tablespoons of the fungicide per gallon of water for spray applications Spray the solution on the apple trees, ensuring complete coverage of leaves, branches, and fruit. """,
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/>Disease: Cedar Apple Rust<br/>
        ...
        <br/><br/> Fertiliser Recomended/cure the disease <br/>
        <br/>1. Name: Bonide Fung-onil Multi-Purpose Fungicide , Miracle-Gro Tree & Shrub Plant Food Spikes ,Jobe's Organics Fruit & Citrus Fertilizer Spikes.
        <br/>2. Active Ingredient: Chlorothalonil.
        <br/>3. Deficiency : What It Addresses: Boosts Nitrogen for vigorous growth, Phosphorus for strong roots, and Potassium to enhance rust resistance .
        <br/>4. Price:  Approximately $10-15 for a 16 oz bottle (price may vary based on location and supplier).
        <br/>5. Shake the bottle well before use Mix 1.5 teaspoons of the fungicide per gallon of water for spray applications. """,
    'Apple___healthy': """ <b>Crop</b>: Apple <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Here is Optional spray For your Good Quality Fruits BioAdvanced Natria Disease Control for Gardens . """,
